...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-business-dev-secret')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'business_db'),
        'USER': os.environ.get('DB_USER', 'business_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'business_pass'),
